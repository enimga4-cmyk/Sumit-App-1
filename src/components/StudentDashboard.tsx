...
export default function StudentDashboard({
  ...
  return (
    <div className="flex flex-col gap-3 overflow-x-hidden pb-6 animate-fadeIn" id="student-dashboard-root">
      ...
      <HeroCard student={student} onOpenAvatarModal={onOpenAvatarModal} onOpenStudentDetails={() => setShowStudentDetailsModal(true)} formatDate={formatDate} onOpenAnnouncements={() => setShowAnnouncementsModal(true)} hasAnnouncements={announcements.length > 0} />
      ...
      {showAnnouncementsModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 bg-slate-950/70 backdrop-blur-sm animate-fadeIn" onClick={() => setShowAnnouncementsModal(false)}>
